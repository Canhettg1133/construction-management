      ...
      <div className="ml-auto flex items-center gap-1">
        <button
          ...
          className={cn(
            ...
            canPrev ? 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' : 'cursor-not-allowed text-slate-300',
          )}
        ...
        <button
          ...
          className={cn(
            'flex h-8 w-8 items-center justify-center rounded-lg text-sm font-medium transition-colors',
            canNext ? 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' : 'cursor-not-allowed text-slate-300',
          )}
