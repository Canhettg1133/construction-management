...
export function Drawer({ open, onClose, children, position = 'right', title, width = 'w-80', className }: DrawerProps) {
  ...
  return (
    <div ref={overlayRef} className="fixed inset-0 z-50" onClick={(e) => e.target === overlayRef.current && onClose()}>
