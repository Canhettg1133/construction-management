    ...
    <div className="space-y-4">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Tìm theo tên tệp, nhãn và lọc theo dự án.</p>
        </div>
      </div>
      ...
      {!hasSearchInput && (
        <EmptyState
          title="Nhập từ khóa để bắt đầu tìm"
          description="Bạn có thể tìm theo tên tệp, nhãn hoặc chọn dự án."
        />
      )}
      ...
      {!searchQuery.isLoading &&
        ...
        (searchQuery.data ?? []).length === 0 && (
          <EmptyState
            ...
            description="Thử đổi từ khóa, nhãn hoặc bớt điều kiện lọc."
          />
        )}
