    ...
    <div className="app-card">
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-slate-700">Báo cáo chất lượng gần đây</h3>
        </div>
        <span className="text-xs text-slate-500">{reports.length} báo cáo</span>
      </div>

      {reports.length === 0 ? (
        <p className="py-5 text-center text-sm text-slate-500">Chưa có báo cáo chất lượng nào.</p>
      ) : (
