  ...
  return (
    <div className="space-y-4">
      <div className="page-header">
        <div>
          <h1>Thông báo</h1>
          <p className="page-subtitle">Danh sách thông báo mới nhất của bạn.</p>
        </div>
        {unreadCount > 0 ? (
          <button
            type="button"
      ...
      {!initialized ? (
        <div className="app-card py-10 text-center text-sm text-slate-500">Đang tải thông báo...</div>
      ) : notifications.length === 0 ? (
        <div className="app-card py-10 text-center text-sm text-slate-500">Không có thông báo nào.</div>
      ) : (
