  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="page-subtitle">Nhập thông tin giao dịch theo quy trình kho vật tư.</p>
      </div>
      ...
      <div className="app-card space-y-4">
        <div>
          ...
          <select className="form-input" value={inventoryId} onChange={(event) => setInventoryId(event.target.value)}>
