...
projectSettingsPermissionRoutes.get('/permissions', asyncHandler(permissionController.getProjectPermissionMatrix))
...
projectSettingsPermissionRoutes.post('/privileges/assign', asyncHandler(permissionController.assignSpecialPrivilege))
projectSettingsPermissionRoutes.delete(
