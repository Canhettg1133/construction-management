...
import { authenticate, validate, asyncHandler, loginRateLimit } from "../../shared/middleware";
...
router.post("/forgot-password", loginRateLimit, validate(forgotPasswordSchema), asyncHandler(authController.forgotPassword));
