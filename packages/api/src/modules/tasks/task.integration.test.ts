...
describe('Tasks - request contract', () => {
  ...
  it('GET /projects/:projectId/tasks returns task list', async () => {
    const res = await request(app).get(`/api/v1/projects/${PROJECT_ID}/tasks`).set('Cookie', buildAuthCookie('VIEWER'))
  ...
  it('GET /projects/:projectId/tasks/:taskId/comments requires auth', async () => {
    const res = await request(app).get(
      `/api/v1/projects/${PROJECT_ID}/tasks/00000000-0000-0000-0000-000000000001/comments`,
    )
