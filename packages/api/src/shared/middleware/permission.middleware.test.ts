...
const { requireProjectMembership, loadUserPermissions, requireToolPermission } = await import('./permission.middleware')

function runMiddleware(middleware: (req: any, res: any, next: (error?: unknown) => void) => void, req: any) {
