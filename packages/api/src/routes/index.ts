...
import permissionRoutes, { projectSettingsPermissionRoutes } from '../modules/permissions/permission.routes'
...
import aiAssistantRoutes, { aiProviderProfileRoutes, aiSettingsRoutes } from '../modules/ai-assistant/ai.routes'
